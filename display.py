...
page = """
<|layout|columns=250px 1|gap=0px|
<|part|render=True|class_name=sidebar|padding=1.5rem|
#  **Nova Assistant**{: .color-primary}  
_Your Smart Voice Companion_

<|New Conversation|button|class_name=fullwidth plain|id=reset_app_button|on_action=erase_conv|>

<br/>
<|{status}|text|class_name=status-label|>
|>

<|part|render=True|class_name=chat-container|padding=1rem|
...
gui = Gui(page, css_file="display.css")
